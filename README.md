...
$ brew install kusiormarcin/tap/docker-mac-net-connect

# Run the service and register it to launch at boot
$ sudo brew services start kusiormarcin/tap/docker-mac-net-connect
```
...
```bash
HOMEBREW_GOPROXY=https://my-proxy-url brew install kusiormarcin/tap/docker-mac-net-connect
```
...
```
sudo brew services stop kusiormarcin/tap/docker-mac-net-connect
