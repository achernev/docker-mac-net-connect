...
$ brew install achernev/tap/docker-mac-net-connect

# Run the service and register it to launch at boot
$ sudo brew services start achernev/tap/docker-mac-net-connect
```
...
```bash
HOMEBREW_GOPROXY=https://my-proxy-url brew install achernev/tap/docker-mac-net-connect
```
...
```
sudo brew services stop achernev/tap/docker-mac-net-connect
